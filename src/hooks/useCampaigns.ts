...
let query = supabase
.from('campaigns')
.select(*, organizer:profiles!campaigns_organizer_id_fkey(id, full_name, avatar_url, role), photographer:profiles!campaigns_photographer_id_fkey(id, full_name, avatar_url, role), photos(id, url, thumbnail_url, moderation_status, tags, bib_number), donations(id, amount, donor_name, created_at));
codeCode
...
const { data, error } = await supabase
.from('campaigns')
.select(*, page_views, organizer:profiles!campaigns_organizer_id_fkey(id, full_name, avatar_url, role), photographer:profiles!campaigns_photographer_id_fkey(id, full_name, avatar_url, role), photos(id, moderation_status), donations(id, amount, created_at, donor_name))
